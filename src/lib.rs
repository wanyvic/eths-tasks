...
use crate::shutdown::{signal, GracefulShutdown, GracefulShutdownGuard, Shutdown, Signal};
...
/// ```
/// # async fn t() {
/// use eths_tasks::{TaskSpawner, TokioTaskExecutor};
...
///
/// ```
/// # use eths_tasks::TaskManager;
/// fn t() {
///  use eths_tasks::TaskSpawner;
...
impl TaskExecutor {
    ...
    ///
    /// ```no_run
    /// # async fn t(executor: eths_tasks::TaskExecutor) {
    ///
